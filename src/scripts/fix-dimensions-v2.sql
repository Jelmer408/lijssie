...
ALTER TABLE supermarket_offers DROP COLUMN IF EXISTS embedding;

-- 3. Add the column back with correct dimensions
ALTER TABLE supermarket_offers ADD COLUMN embedding vector(384);
