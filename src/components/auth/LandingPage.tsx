...
import { Star, Users, Plus, X, Clock, ShoppingCart, ChefHat, Calendar, Send, Upload, ChevronDown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100/50 overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <span className="relative z-10 text-blue-600 group-hover:text-blue-700">Inloggen</span>
            <motion.div
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
              <Button
                onClick={() => setShowLogin(true)}
                className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-6 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                Start gratis
              </Button>
              <Button
