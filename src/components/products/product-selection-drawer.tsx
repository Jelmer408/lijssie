              ...
              <div className="space-y-2">
                {isLoading ? (
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Add "Can't find?" section */}
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      transition={{ delay: 0.3 }}
                      className="mt-6 p-4 rounded-xl bg-blue-50/50 border border-blue-100/50"
                    >
                      <div className="flex flex-col items-center text-center space-y-2">
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={() => setShowCategorySelection(true)}
                          className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 bg-white hover:bg-blue-50 rounded-lg border border-blue-200 transition-colors shadow-sm"
                        >
                          <Package className="w-4 h-4" />
                          Selecteer handmatig een categorie
                        </motion.button>
                      </div>
                    </motion.div>
                  </div>
